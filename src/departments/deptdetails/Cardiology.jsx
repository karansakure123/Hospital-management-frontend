...
const Cardiology = () => {
  ...
  useEffect(() => {
    ...
    const fetchCardioData = async () => {
      try {
        const response = await axios.get(
          "https://hospital-management-backend-4.onrender.com/api/v1/cardiology/getall" // Update the endpoint for cardiology
        );
    ...
    const fetchDoctors = async () => {
      try {
        const response = await axios.get(
          "https://hospital-management-backend-4.onrender.com/api/v1/user/doctors?department=Cardiology" // Update department to Cardiology
        );
