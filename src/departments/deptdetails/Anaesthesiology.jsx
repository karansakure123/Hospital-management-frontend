...
const Anaesth = () => {
  ...
  useEffect(() => {
    ...
    const fetchAnaesthData = async () => {
      try {
        const response = await axios.get(
          "https://hospital-management-backend-4.onrender.com/api/v1/anaesthesio/getall"
        );
    ...
    const fetchDoctors = async () => {
      try {
        const response = await axios.get(
          "https://hospital-management-backend-4.onrender.com/api/v1/user/doctors?department=Anaesthesiology"
        );
